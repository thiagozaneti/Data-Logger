#include "RS485ModbusMaster_V2.h"
...
unsigned char getData()
{
  unsigned char buffer = 0;
	...
	if(Serial2.available()) Serial.print("RECEBIDO RX <- ");
...
void modbus_configure(long baud, unsigned int _timeout, unsigned int _polling, 
										...
										Packet* _packet, unsigned int _total_no_of_packets, unsigned int RXPin, unsigned int TXPin)
{
